...
class AmyloidFDGDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.DATA_DIR = "/Users/todd/code/research/cafn/data/lowdose-pet-fdg-nifti"
    ...
    def __getitem__(self, i):
        ...
        return {'A': low_dose_img, 'B': full_dose_img, 'A_paths': self.low_dose_filenames[scan_index],
